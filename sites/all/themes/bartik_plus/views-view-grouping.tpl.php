<?php
  ...
  */
?>
<div class="view-grouping view-grouping-<?php print $grouping_level; ?>">
  <div class="view-grouping-header view-group-level-<?php print $grouping_level; ?>"><?php print $title; ?></div>
